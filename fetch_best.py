...
def auto_text(rects):
    for rect in rects:
        plt.text(x=rect.get_x()+0.1, y=rect.get_height()-0.09,
...
folder = "data/FetchReacher"
value = "eval/mean_reward"

id = "0"
env = "FetchReacher-v" + id
env_promp = "FetchReacherProMP-v" + id
...
tikzplotlib.save("./data/FetchReacher/fetchv" + id +"_best.tex")
